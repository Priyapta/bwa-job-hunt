...
function CategoryItem({ name, totalJobs }: CategoryItemProps) {
  return (
    <div className="border border-border p-8 cursor-pointer transition-colors group hover:border-primary hover:bg-primary hover:text-white">
      ...
      <div className="mt-7">
        ...
        <div className="text-muted-foreground inline-flex items-center gap-1 mt-1 grup-hover:text-white">
          <span>{totalJobs} jobs availaible</span>
